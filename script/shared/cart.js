...
export function generateProductHTML(product) {
  return `
        ...
        <div class="product-details">
          <a class="product-name" href="product-details.html?id=${product.id}"
          class="js-product-details-link">${product.name}</a>
...
return `      <div class="summary-section">
        ...
        <div class="grid-order-summary-details">
          <p class="grid-order-summary-details-text-format">Tax</p>
          <p class="js-add-tax">$0</p>
        </div>
      </div>
